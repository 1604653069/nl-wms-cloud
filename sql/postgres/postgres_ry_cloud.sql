...
insert into sys_menu values('4', 'PLUS官网', '0', '4', 'https://gitee.com/dromara/wms-cloud-Plus', null, '', '0', '0', 'M', '0', '0', '', 'guide',    'admin', now(), '', null, 'wms-cloud-Plus官网地址');
-- 二级菜单
...
insert into sys_oss_config values (4, 'qcloud', 'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'wms-1250000000',  '', 'cos.ap-beijing.myqcloud.com',         '','N', 'ap-beijing',  '1', '1', '', 'admin', now(), 'admin', now(), null);
